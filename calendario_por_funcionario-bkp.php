...
//                           
                             if (in_array($diacorrente+1, $array)){
                                echo "<a href = ".$_SERVER["PHP_SELF"]."?dia=".($diacorrente+1)."><b><font color='black'>".++$diacorrente . "</font></b></a>";  //Se Atender a CONDIÇÃO, o dia aparece destacado.
                             } else{
                                    echo "<a href = ".$_SERVER["PHP_SELF"]."?dia=".($diacorrente+1).">".++$diacorrente . "</a>"; //Restante dos dias aparecem normais.
                                }
