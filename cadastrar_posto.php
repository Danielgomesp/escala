...
<html>
    <head>
        ...
        <title>Escala - Cadastrar Postos</title>    
        <!-- Bootstrap -->
            ...
            <div class="row">
                 <div class="col-md-4 order-md-2 mb-4">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        <span class="text-muted">Postos de Trabalho</span>
                        <span class="badge badge-secondary badge-pill"><!--número de colaboradores cadastrados -->
                            <?php
                            include 'conn.php';
                            $qr_count = "select count(*) as total from Posto;";
                ...
                <!-- Tela de Cadastro -->
                <form method="post" action="cadastrando_posto.php">
                    <div class="col-md-8 order-md-1">
                        <h4 class="mb-3">Cadastro de Posto</h4>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="firstName">Posto de trabalho</label>
                                <input type="text" class="form-control" name="descricao" id="descricao" placeholder="Ex.: 150 - McDonalds" required>
