    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- Tela de Cadastro -->
                <form method="post" action="cadastrando_colaborador_turno.php">
                    <div class="col-md-8 order-md-1">
                        <h4 class="mb-2">Cadastro de  Variáveis Para o Colaborador: </h4>
                    ...
                    <hr class="mb-4">
                    <h4 class="mb-3">Disponibilidade de Turno</h4>
